...
# rubyのloggerを使いたいがdailyにバグあり。
# なので別名にして使用する。
# https://github.com/ruby/ruby/commit/f6e77b9d3555c1fbaa8aab1cdc0bd6bde95f62c6#diff-ed933b39679c4030b3938215e4ab1ada
...
class BasicLogger
  ...
  class LogDevice
    ...
    def add_log_header(file)
      file.write(
          "# Logfile created on %s by %s\n" % [Time.now.to_s, BasicLogger::ProgName]
      ) if file.size == 0
    end
